...
def create_point():
    ...
    area_x = int(input("X coordinate of this area = ")) #meter
    area_y = int(input("Y coordinate of this area = ")) #meter
    density = float(input("Node density = ")) #nodes/meter^2
    clus_density = float(input("Cluster density = "))
    num_base = int(input("How many base station in this area = "))
